...
*/
exports.coupon = {};
exports.coupon.create = async function({ id, amount_off, currency, duration, max_redemptions, metadata }){
...
*/
exports.coupon.delete = async function(id){
  return await stripe.coupons.del(id);
}
...
exports.promotionCode.create = async function({ coupon, code, active = true }){
